public class MyClass
{
    ...
    // Overload the + operator to handle addition correctly
    public static MyClass operator +(MyClass obj1, int value)
    {
        return new MyClass(obj1.MyProperty + value);
    }
}
...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        MyClass obj3 = obj2 + 5; // Now correctly adds 5 to the MyProperty
